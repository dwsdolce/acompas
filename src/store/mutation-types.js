...
export const SELECT_SWING = 'SELECT_SWING'
...
export const TUNING_FORK_PLAY = 'TUNING_FORK_PLAY'
export const TUNING_FORK_STOP = 'TUNING_FORK_STOP'
export const TUNING_CHANGE_NOTE = 'TUNING_CHANGE_NOTE'
